...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	private String fieldlabels;		// fieldlabels
	private String fieldkeys;		// fieldkeys
	private String searchlabel;		// searchlabel
	private String searchkey;		// searchkey
	private String validatetype;		// validatetype
	private String minLength;		// min_length
	private String maxLength;		// max_length
	private String minValue;		// min_value
	private String maxValue;		// max_value
	private String dataurl;		// dataurl
	private String oldName;		// old_name
	private String oldComments;		// old_comments
	private String oldJdbcType;		// old_jdbc_type
	private String oldIsPk;		// old_is_pk
